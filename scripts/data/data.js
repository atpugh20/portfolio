...
const projectData = [
  ...
  },
  {
    ...
    description2:
      "Currently, Buttercup Go! itself has been disabled, and is unavailable to be played. However, the code for this bot can still be seen in its GitHub repository, which can be found by clicking the link above.",
